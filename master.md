...
![整体系统架构图](./diagrams/system-architecture.mmd)
...
![BPMN业务流程图](./diagrams/bpmn-workflow.mmd)
...
![RBAC权限矩阵图](./diagrams/rbac-matrix.mmd)
...
![RAG智能层架构图](./diagrams/rag-architecture.mmd)
...
![第三方集成架构图](./diagrams/third-party-integration.mmd)
...
![分阶段实施路线图](./diagrams/implementation-roadmap.mmd)
...
![技术栈选型思维导图](./diagrams/technology-stack.mmd)
...
![数据库设计ER图](./diagrams/database-design.mmd)
